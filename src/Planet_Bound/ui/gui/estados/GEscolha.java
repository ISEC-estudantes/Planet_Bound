...
public class GEscolha extends VBox {
   // final int RETANGULO_SIZE = 20;
    final Label questao;
    final HBox escolhas;
    final EstadoJogo lastState;
    private final ShipObservavel modelo;
    final HBox questaoBox;
    final Rectangle questaoSquare;
    ...
    public GEscolha(ShipObservavel model) {
        ...
        questaoSquare.setHeight(Helper.RETANGLE_SIZE);
        questaoSquare.setWidth(Helper.RETANGLE_SIZE);
        questao = new Label();
        questaoBox = new HBox();
    ...
    private void setUpButtons() {
        ...
        if (estado == EstadoJogo.NovoShip) {
            ...
            //buttao de voltar para os estados que o tem
            //var sair = new Button(optionsString.get(0));
            //sair.setOnAction(e -> modelo.setOpcao(0));
    ...
    private void bSOSquares(Pane pane, Resource resource) {
        ...
        tempSquare.setWidth(Helper.RETANGLE_SIZE);
        tempSquare.setHeight(Helper.RETANGLE_SIZE);
