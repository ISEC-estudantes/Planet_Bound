...
public class ShipDados {
     ...
     * @{
     * Gestão de eventos num modo estatico, para mais sobre os eventos leia \link Planet_Bound.logica.dados.events.Event Event \endlink
     * @}
     */
